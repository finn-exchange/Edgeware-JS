...
function Mnemonic ({ address, className, evmAddress, evmName, isConnectWhenCreate, name, onConnectWhenCreate, onNextStep, onSelectAccountCreated, seed, selectedGenesis }: Props): React.ReactElement<Props> {
